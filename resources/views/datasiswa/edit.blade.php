        ...
        <div class="row">
            <div class="card recent-sales overflow-auto">
                <div class="card-body">
                    ...
                    <!-- Horizontal Form -->
                    <form class="form-horizontal" action="{{ url('siswa/' . $jenis->nis)  }}" method="post" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <div class="row mb-3">
                            <label for="nis" class="col-sm-2 col-form-label">NIS</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="nis" id="nis" value="{{ old('nis', $jenis->nis) }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="jenis_barang" class="col-sm-2 col-form-label">Nama</label>
                            <div class="col-sm-10">
